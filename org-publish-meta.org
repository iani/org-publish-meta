#+PROJECT: default
#+TODO: TODO UNDERWAY MUST_REVISIT MUST_IMPLEMENT CONSIDER_IMPLEMENTING_THIS_FEATURE | DONE CANCELLED OBSOLETE
...
- If a node tagged PROJECT_DEFS exists, and contains at least one valid project definition as a subnode, then *the first* valid definition becomes the files' project config.  
