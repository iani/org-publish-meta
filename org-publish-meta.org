...
**** 1. Indicate in project definition through property include-containing-file
...
**** 2. Indicate the project to which the file belongs through file property "PROJECT"
...
*** Publishing contents of node in "raw" css, javascript, html
