...
This [[#761FD20C-6A4E-4AC4-97D8-DBF51FCFBFE7][node]] gives a working fix for inserting file links. 

I now ([2013-12-05 Thu 11:04]) compared the way my modification works with the unmodified original org-mode code, and the original *does not insert file info in the links*.   Even if the target is in a different file than the link.  So the modifications in [[#761FD20C-6A4E-4AC4-97D8-DBF51FCFBFE7][this node]] seem to work for now. 

Here we tried to create an id and a link from it, again, using ID instead of CUSTOM ID. We tested this in a different file, and confirmed that the original org-mode code does not insert the file info. 
 [[id:01B5BF3F-E148-404C-9A2F-E8ADFED3EDF7][link test only]]. 

****** link test only
:PROPERTIES:
:DATE:     <2013-12-05 Thu 11:03>
:ID:       01B5BF3F-E148-404C-9A2F-E8ADFED3EDF7
:END:



****** Yes, this works after all (with a little, non-obnoxious caveat)
:PROPERTIES:
:CUSTOM_ID: 761FD20C-6A4E-4AC4-97D8-DBF51FCFBFE7
:ID:       BC2989C9-2ED9-46BB-BCFF-50424ACAFC09
:END:

Correction: The link insertion works correctly with this version. 

If the link is inserted in the same file, the file name is not included. 

If it is inserted in a different file than the target, then the file path to the target is also included!
