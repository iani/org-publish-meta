#+TODO: TODO UNDERWAY MUST_REVISIT | DONE CANCELLED OBSOLETE
...
**** Indicate in a project definition node through property include-containing-file

Indicate this in a project definition contained in the same file.  This is done by setting the project property include-containing-file to t.  For example, the following project definition of project "blog", indicates that the file containing the project definition should published as part of the project "blog".  This way of indicating is perhaps more indirect than with a proeprty at the header of the file, but it has the advantage that if the name of the project is changed later, the file will still belong to the project, without having to change the name in the header of the file.
