...
*** IMPORTANT: use elisp links to build this function into the org-pm-list-project-defs org-buffer!

use elisp links to build this function into the org-pm-list-project-defs 
See:  http://stackoverflow.com/questions/5043895/how-to-call-emacs-lisp-functions-in-emacs-org-mod
Adapt this to call the function you need with the file + node:
[[elisp:(insert "abc.txt")]]
