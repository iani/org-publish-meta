...
** Short list of commands and keyboard shortcuts
...
| H-m m or H-m p m         | org-pm-make-projects (this file)            |
...
| H-m ?????                | org-pm-show-target-file-list ???            |
|--------------------------+---------------------------------------------|
| SAVED DATA               |                                             |
|--------------------------+---------------------------------------------|
...
* Add/remove projects to sections
...
** org-pm-get-non-project-tags                                :test:_test2_:
...
#+BEGIN_SRC elisp
  (save-excursion
    (org-back-to-heading)
    (org-pm-get-non-project-tags (cadr (org-element-at-point))))
#+END_SRC
...
*** COMMENT Copy files / sections to project targets
#+BEGIN_SRC emacs-lisp
  (defun org-pm-export ()
...
*** TODO List files exported to projects
...
* Info, Menus, Project and File Management, Keyboard Shortcuts
...
** Post and edit project definition list
*** org-pm-post-project-def
:PROPERTIES:
